 ...
 * znajdujace sie w nim jako stringi. Mozna podac filtr w ktorym po podaniu rozszerzen
 * tylko pliki z tymi rozszerzeniami pozostana w wektorze
 ...
 */
template<typename T>
void ReadDirectory(std::string, std::vector<T> &, const std::vector<std::string> & = {},
				   bool = false, bool = false);

/**
 * Otwiera binarnie plik i czyta jego zawartosc
 * @param sciezka do pliku do otworzenia
 * @param maksymalny rozmiar pliku [wielkosc bufora] | jesli plik jest wiekszy rzuci
 * wyjatek
