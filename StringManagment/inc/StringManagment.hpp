 ...
 * @param napis do edycji
 * @param napis ktory zawiera znaki do usuniecia z przodu i tylu napisu | domniemanie "
 * \t"
 */
 ...
 * @param napis ktory zawiera znaki ktoych ciagi beda zamieniane | domniemanie " \t"
 */
std::string RemoveDoubleWS(std::string, const std::string = " ",
						   const std::string = " \t");
/*
 ...
 * @param napis ktory zawiera znaki ktoych ciagi beda zamieniane | domniemanie " \t"
 */
std::wstring RemoveDoubleWSW(std::wstring, const std::wstring = L" ",
							 const std::wstring = L" \t");
}  // namespace sm
